...
For a this approach we will have to consider CAC and CLV we previously calculated on Assignment 1 for each customer (note that we already have it in the customer.active dataset that we then merged with tx.all to get customer.LCG) 
