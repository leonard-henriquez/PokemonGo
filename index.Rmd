...
```{r}
customer.active <- customer.active %>% mutate(CLV = CLV(CLV.const, model, CustomerID))
summary(customer.active)
```
...
> Remider: we working on the "active" basetable (customer that played at least once during the summer), regardless wether they made transactions in summer or not
